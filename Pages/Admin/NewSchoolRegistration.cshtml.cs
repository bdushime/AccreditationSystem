...
using ResponsiveEducationPortal.Models;
using System;
...
namespace ResponsiveEducationPortal.Pages
{
    public class NewSchoolRegistrationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                string connectionString = "Data Source=kyrie\\SQLEXPRESS;Initial Catalog=accreditation_sys_db;Integrated Security=True;TrustServerCertificate=True";
